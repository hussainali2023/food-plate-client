...
const Footer = () => {
  return (
    <footer className="px-4 bottom-0 divide-y bg-emerald-800 dark:text-gray-100">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            ...
            <span className=" text-3xl text-white font-bold">Food Plate</span>
          </Link>
        </div>
      ...
      <div className="py-6 text-sm text-center dark:text-white">
        © 2023 Food Plate. All rights reserved.
      </div>
    </footer>
  );
};
